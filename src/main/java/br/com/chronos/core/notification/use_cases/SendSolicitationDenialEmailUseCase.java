...
public class SendSolicitationDenialEmailUseCase {
  private final EmailProvider emailProvider;

  public SendSolicitationDenialEmailUseCase(EmailProvider emailProvider) {
    this.emailProvider = emailProvider;
  }

  public void execute(String employeeName, String employeeEmail, String solicitationType) {
    emailProvider.sendSolicitationDenialEmail(
