...
public class AttachJustificationToSolicitationController {
  ...
  public ResponseEntity<ExcuseAbsenceSolicitationDto> handle(
    ...
    var useCase = new AttachJustificationToSolicitationUseCase(solicitationsRepository,justificationRepository);
