...
import br.com.chronos.core.portal.use_cases.ApproveDayOffScheduleAdjustmentSolicitationUseCase;
import lombok.Data;

@SolicitationsController
public class ApproveDayOffScheduleAdjustmentSolicitationController {
  @Autowired
  ...
  @PutMapping("/{solicitationId}/approve/day-off-schedule-adjustment")
  public ResponseEntity<SolicitationDto> handle(
      @PathVariable String solicitationId,
      @RequestBody Request body) {
    var useCase = new ApproveDayOffScheduleAdjustmentSolicitationUseCase(solicitationsRepository, portalBroker);
