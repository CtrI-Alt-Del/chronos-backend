...
import br.com.chronos.core.solicitation.use_cases.ApprovePaidOvertimeSolicitationUseCase;

@SolicitationsController
public class ApprovePaidOvertimeSolicitationController {
  @Autowired
  ...
  @PutMapping("/{solicitationId}/approve/paid-overtime")
  public ResponseEntity<SolicitationDto> handle(
      @PathVariable String solicitationId,
      @RequestBody Request body) {
    var useCase = new ApprovePaidOvertimeSolicitationUseCase(solicitationsRepository, portalBroker);
