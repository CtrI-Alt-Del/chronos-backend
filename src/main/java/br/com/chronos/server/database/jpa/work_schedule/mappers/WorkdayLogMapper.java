...
public class WorkdayLogMapper {
  public WorkdayLogModel toModel(WorkdayLog entity) {
    ...
    var model = WorkdayLogModel
        ...
        .firstClockIn(
            (timePunch.getFirstClockIn() != null) ? timePunch.getFirstClockIn().value() : null)
        .firstClockOut(
            (timePunch.getFirstClockOut() != null) ? timePunch.getFirstClockOut().value() : null)
        .secondClockIn(
            (timePunch.getSecondClockIn() != null) ? timePunch.getSecondClockIn().value() : null)
        .secondClockOut(
            (timePunch.getSecondClockOut() != null) ? timePunch.getSecondClockOut().value() : null)
